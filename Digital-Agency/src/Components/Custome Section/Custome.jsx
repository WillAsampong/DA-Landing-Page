...
const Custome = () => {
  return (
    <div>
      <section className='mb-20 mt-20 md:flex md:justify-between'>
        <div className="flex flex-col gap-y-12 my-auto mb-8 md:my-auto md:max-w-md">
          <h2 className="font-bold text-center text-3xl md:text-left">Custome & Plugin Development</h2>
          <div>
